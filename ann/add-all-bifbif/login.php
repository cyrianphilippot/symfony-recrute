			...
			<div class="row">
			    <div class="col s12 m8 l6 ">
			        <form action="login_post.php" method="post">
			            ...
			            <label for="password" >MDP</label> :  <input name="password" id="password" type="password" class="validate"/><br />
			            <input class="waves-effect waves-light btn" type="submit" value="Envoyer" />
			        	</p>
			        </form>
			    </div>
			</div>
			<p>Tjrs pas de compte ? tu trolls ! <a href="register.php">Je fais mon compte vite vite on est préssé !</a></p>
