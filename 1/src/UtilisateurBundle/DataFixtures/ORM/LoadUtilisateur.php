...
class LoadUtilisateur extends AbstractFixture implements OrderedFixtureInterface, ContainerAwareInterface
{
    /**
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $Utilisateur3->setRoles(array('ROLE_ADMIN'));
        $Utilisateur3->setEnabled('1');
        $encoder = $this->container->get('security.password_encoder');
        $password = $encoder->encodePassword($Utilisateur3, 'admin');
